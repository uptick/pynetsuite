...
class TestInvoiceTimeCollection(unittest.TestCase):
    """InvoiceTimeCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvoiceTimeCollection:
        """Test InvoiceTimeCollection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvoiceTimeCollection`
        """
        model = InvoiceTimeCollection()
        if include_optional:
            return InvoiceTimeCollection(
                links = [
    ...
    def testInvoiceTimeCollection(self):
        """Test InvoiceTimeCollection"""
