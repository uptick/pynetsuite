...
class TestCurrencyCollection(unittest.TestCase):
    """CurrencyCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CurrencyCollection:
        """Test CurrencyCollection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CurrencyCollection`
        """
        model = CurrencyCollection()
        if include_optional:
            return CurrencyCollection(
                total_results = 56,
                items = [
                    pynetsuite.models.currency.currency(
                        is_inactive = True, 
                        symbol = '', 
    ...
    def testCurrencyCollection(self):
        """Test CurrencyCollection"""
