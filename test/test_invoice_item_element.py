...
class TestInvoiceItemElement(unittest.TestCase):
    """InvoiceItemElement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvoiceItemElement:
        """Test InvoiceItemElement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvoiceItemElement`
        """
        model = InvoiceItemElement()
        if include_optional:
    ...
    def testInvoiceItemElement(self):
        """Test InvoiceItemElement"""
