...
**bill_receipts** | [**NsResourceCollection**](NsResourceCollection.md) |  | [optional] 
...
**inventory_detail** | [**VendorBillItemInventoryDetail**](VendorBillItemInventoryDetail.md) |  | [optional] 
...
**catch_up_period** | [**NsResource**](NsResource.md) |  | [optional] 
...
vendor_bill_item_element_instance = VendorBillItemElement.from_json(json)
# print the JSON string representation of the object
print(VendorBillItemElement.to_json())

# convert the object into a dict
vendor_bill_item_element_dict = vendor_bill_item_element_instance.to_dict()
# create an instance of VendorBillItemElement from a dict
vendor_bill_item_element_from_dict = VendorBillItemElement.from_dict(vendor_bill_item_element_dict)
```
