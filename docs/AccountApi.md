# pynetsuite.AccountApi

All URIs are relative to *https://account_id.suitetalk.api.netsuite.com/services/rest/record/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**account_get**](AccountApi.md#account_get) | **GET** /account | Get list of records.
[**account_id_delete**](AccountApi.md#account_id_delete) | **DELETE** /account/{id} | Remove record.
[**account_id_get**](AccountApi.md#account_id_get) | **GET** /account/{id} | Get record.
[**account_id_patch**](AccountApi.md#account_id_patch) | **PATCH** /account/{id} | Update record.
[**account_id_put**](AccountApi.md#account_id_put) | **PUT** /account/{id} | Insert or update record.
[**account_post**](AccountApi.md#account_post) | **POST** /account | Insert record.


# **account_get**
> AccountCollection account_get(prefer=prefer, x_net_suite_idempotency_key=x_net_suite_idempotency_key, q=q, limit=limit, offset=offset)
...
# **account_id_delete**
> account_id_delete(id, prefer=prefer, x_net_suite_idempotency_key=x_net_suite_idempotency_key)
...
with pynetsuite.ApiClient(configuration) as api_client:
    ...
    try:
        # Remove record.
        api_instance.account_id_delete(id, prefer=prefer, x_net_suite_idempotency_key=x_net_suite_idempotency_key)
    except Exception as e:
        print("Exception when calling AccountApi->account_id_delete: %s\n" % e)
```
...
# **account_id_get**
> Account account_id_get(id, prefer=prefer, x_net_suite_idempotency_key=x_net_suite_idempotency_key, expand_sub_resources=expand_sub_resources, simple_enum_format=simple_enum_format, fields=fields)
...
with pynetsuite.ApiClient(configuration) as api_client:
    ...
    try:
        # Get record.
        api_response = api_instance.account_id_get(id, prefer=prefer, x_net_suite_idempotency_key=x_net_suite_idempotency_key, expand_sub_resources=expand_sub_resources, simple_enum_format=simple_enum_format, fields=fields)
        print("The response of AccountApi->account_id_get:\n")
        pprint(api_response)
    except Exception as e:
...
with pynetsuite.ApiClient(configuration) as api_client:
    ...
    api_instance = pynetsuite.AccountApi(api_client)
    id = 56 # int | Internal identifier.
    account = pynetsuite.Account() # Account | Request body.
    prefer = 'prefer_example' # str | The server behavior requested by the client. Use 'respond-async' to execute the request asynchronously. If the request is executed asynchronously, 'Preference-applied: respond-async' is returned in the response. (optional)
    x_net_suite_idempotency_key = 'x_net_suite_idempotency_key_example' # str | A user-defined unique idempotency key that is applied to every asynchronous requests to ensure that the request is executed only once. Only one request can be executed with every unique idempotency key. Use UUID in string format as defined by RFC 4122. If the request is executed synchronously, this value is ignored. (optional)
    ...
    try:
        # Update record.
        api_instance.account_id_patch(id, account, prefer=prefer, x_net_suite_idempotency_key=x_net_suite_idempotency_key, x_net_suite_property_name_validation=x_net_suite_property_name_validation, x_net_suite_property_value_validation=x_net_suite_property_value_validation, replace=replace, replace_selected_fields=replace_selected_fields)
    except Exception as e:
        print("Exception when calling AccountApi->account_id_patch: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **id** | **int**| Internal identifier. | 
 **account** | [**Account**](Account.md)| Request body. | 
 **prefer** | **str**| The server behavior requested by the client. Use &#39;respond-async&#39; to execute the request asynchronously. If the request is executed asynchronously, &#39;Preference-applied: respond-async&#39; is returned in the response. | [optional] 
 **x_net_suite_idempotency_key** | **str**| A user-defined unique idempotency key that is applied to every asynchronous requests to ensure that the request is executed only once. Only one request can be executed with every unique idempotency key. Use UUID in string format as defined by RFC 4122. If the request is executed synchronously, this value is ignored. | [optional] 
...
# **account_id_put**
> account_id_put(id, account, prefer=prefer, x_net_suite_idempotency_key=x_net_suite_idempotency_key, x_net_suite_property_name_validation=x_net_suite_property_name_validation, x_net_suite_property_value_validation=x_net_suite_property_value_validation, replace=replace, replace_selected_fields=replace_selected_fields)
...
with pynetsuite.ApiClient(configuration) as api_client:
    ...
    try:
        # Insert or update record.
        api_instance.account_id_put(id, account, prefer=prefer, x_net_suite_idempotency_key=x_net_suite_idempotency_key, x_net_suite_property_name_validation=x_net_suite_property_name_validation, x_net_suite_property_value_validation=x_net_suite_property_value_validation, replace=replace, replace_selected_fields=replace_selected_fields)
    except Exception as e:
...
# **account_post**
> account_post(account, prefer=prefer, x_net_suite_idempotency_key=x_net_suite_idempotency_key, replace=replace, x_net_suite_property_name_validation=x_net_suite_property_name_validation, x_net_suite_property_value_validation=x_net_suite_property_value_validation)
...
with pynetsuite.ApiClient(configuration) as api_client:
    ...
    try:
        # Insert record.
        api_instance.account_post(account, prefer=prefer, x_net_suite_idempotency_key=x_net_suite_idempotency_key, replace=replace, x_net_suite_property_name_validation=x_net_suite_property_name_validation, x_net_suite_property_value_validation=x_net_suite_property_value_validation)
    except Exception as e:
