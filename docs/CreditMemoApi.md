...
------------- | ------------- | -------------
[**credit_memo_get**](CreditMemoApi.md#credit_memo_get) | **GET** /creditMemo | Get list of records.
[**credit_memo_id_delete**](CreditMemoApi.md#credit_memo_id_delete) | **DELETE** /creditMemo/{id} | Remove record.
[**credit_memo_id_get**](CreditMemoApi.md#credit_memo_id_get) | **GET** /creditMemo/{id} | Get record.
[**credit_memo_id_patch**](CreditMemoApi.md#credit_memo_id_patch) | **PATCH** /creditMemo/{id} | Update record.
[**credit_memo_id_put**](CreditMemoApi.md#credit_memo_id_put) | **PUT** /creditMemo/{id} | Insert or update record.
[**credit_memo_post**](CreditMemoApi.md#credit_memo_post) | **POST** /creditMemo | Insert record.


# **credit_memo_get**
> CreditMemoCollection credit_memo_get(prefer=prefer, x_net_suite_idempotency_key=x_net_suite_idempotency_key, q=q, fields=fields, limit=limit, offset=offset)
...
with pynetsuite.ApiClient(configuration) as api_client:
    ...
    api_instance = pynetsuite.CreditMemoApi(api_client)
    ...
    try:
        # Get list of records.
        api_response = api_instance.credit_memo_get(prefer=prefer, x_net_suite_idempotency_key=x_net_suite_idempotency_key, q=q, fields=fields, limit=limit, offset=offset)
        print("The response of CreditMemoApi->credit_memo_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CreditMemoApi->credit_memo_get: %s\n" % e)
```
...
[**CreditMemoCollection**](CreditMemoCollection.md)
...
# **credit_memo_id_delete**
> credit_memo_id_delete(id, prefer=prefer, x_net_suite_idempotency_key=x_net_suite_idempotency_key)
...
with pynetsuite.ApiClient(configuration) as api_client:
    ...
    try:
        # Remove record.
        api_instance.credit_memo_id_delete(id, prefer=prefer, x_net_suite_idempotency_key=x_net_suite_idempotency_key)
    except Exception as e:
        print("Exception when calling CreditMemoApi->credit_memo_id_delete: %s\n" % e)
```
...
# **credit_memo_id_get**
> CreditMemo credit_memo_id_get(id, prefer=prefer, x_net_suite_idempotency_key=x_net_suite_idempotency_key, expand_sub_resources=expand_sub_resources, simple_enum_format=simple_enum_format, fields=fields)
...
with pynetsuite.ApiClient(configuration) as api_client:
    ...
    try:
        # Get record.
        api_response = api_instance.credit_memo_id_get(id, prefer=prefer, x_net_suite_idempotency_key=x_net_suite_idempotency_key, expand_sub_resources=expand_sub_resources, simple_enum_format=simple_enum_format, fields=fields)
        print("The response of CreditMemoApi->credit_memo_id_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CreditMemoApi->credit_memo_id_get: %s\n" % e)
```
...
with pynetsuite.ApiClient(configuration) as api_client:
    ...
    try:
        # Update record.
        api_instance.credit_memo_id_patch(id, credit_memo, prefer=prefer, x_net_suite_idempotency_key=x_net_suite_idempotency_key, x_net_suite_property_name_validation=x_net_suite_property_name_validation, x_net_suite_property_value_validation=x_net_suite_property_value_validation, replace=replace, replace_selected_fields=replace_selected_fields)
    except Exception as e:
        print("Exception when calling CreditMemoApi->credit_memo_id_patch: %s\n" % e)
```
...
# **credit_memo_id_put**
> credit_memo_id_put(id, credit_memo, prefer=prefer, x_net_suite_idempotency_key=x_net_suite_idempotency_key, x_net_suite_property_name_validation=x_net_suite_property_name_validation, x_net_suite_property_value_validation=x_net_suite_property_value_validation, replace=replace, replace_selected_fields=replace_selected_fields)
...
with pynetsuite.ApiClient(configuration) as api_client:
    ...
    try:
        # Insert or update record.
        api_instance.credit_memo_id_put(id, credit_memo, prefer=prefer, x_net_suite_idempotency_key=x_net_suite_idempotency_key, x_net_suite_property_name_validation=x_net_suite_property_name_validation, x_net_suite_property_value_validation=x_net_suite_property_value_validation, replace=replace, replace_selected_fields=replace_selected_fields)
    except Exception as e:
        print("Exception when calling CreditMemoApi->credit_memo_id_put: %s\n" % e)
```
...
# **credit_memo_post**
> credit_memo_post(credit_memo, prefer=prefer, x_net_suite_idempotency_key=x_net_suite_idempotency_key, replace=replace, x_net_suite_property_name_validation=x_net_suite_property_name_validation, x_net_suite_property_value_validation=x_net_suite_property_value_validation)
...
with pynetsuite.ApiClient(configuration) as api_client:
    ...
    try:
        # Insert record.
        api_instance.credit_memo_post(credit_memo, prefer=prefer, x_net_suite_idempotency_key=x_net_suite_idempotency_key, replace=replace, x_net_suite_property_name_validation=x_net_suite_property_name_validation, x_net_suite_property_value_validation=x_net_suite_property_value_validation)
    except Exception as e:
        print("Exception when calling CreditMemoApi->credit_memo_post: %s\n" % e)
```
