...
# **invoice_get**
> InvoiceCollection invoice_get(prefer=prefer, x_net_suite_idempotency_key=x_net_suite_idempotency_key, q=q, fields=fields, limit=limit, offset=offset)
...
with pynetsuite.ApiClient(configuration) as api_client:
    ...
    try:
        # Get list of records.
        api_response = api_instance.invoice_get(prefer=prefer, x_net_suite_idempotency_key=x_net_suite_idempotency_key, q=q, fields=fields, limit=limit, offset=offset)
