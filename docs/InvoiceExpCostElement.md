...
**employee** | [**NsResource**](NsResource.md) |  | [optional] 
...
json = "{}"
# create an instance of InvoiceExpCostElement from a JSON string
invoice_exp_cost_element_instance = InvoiceExpCostElement.from_json(json)
# print the JSON string representation of the object
print(InvoiceExpCostElement.to_json())

# convert the object into a dict
invoice_exp_cost_element_dict = invoice_exp_cost_element_instance.to_dict()
# create an instance of InvoiceExpCostElement from a dict
invoice_exp_cost_element_from_dict = InvoiceExpCostElement.from_dict(invoice_exp_cost_element_dict)
```
