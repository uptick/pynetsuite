...
class CurrencyApi:
    ...
    def currency_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CurrencyCollection]:
        """Get list of records.
    ...
    def currency_id_delete(
        ...
        _param = self._currency_id_delete_serialize(
            id=id,
            prefer=prefer,
            x_net_suite_idempotency_key=x_net_suite_idempotency_key,
            _request_auth=_request_auth,
    ...
    @validate_call
    def currency_id_delete_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Internal identifier.")],
        prefer: Annotated[Optional[StrictStr], Field(description="The server behavior requested by the client. Use 'respond-async' to execute the request asynchronously. If the request is executed asynchronously, 'Preference-applied: respond-async' is returned in the response.")] = None,
        x_net_suite_idempotency_key: Annotated[Optional[StrictStr], Field(description="A user-defined unique idempotency key that is applied to every asynchronous requests to ensure that the request is executed only once. Only one request can be executed with every unique idempotency key. Use UUID in string format as defined by RFC 4122. If the request is executed synchronously, this value is ignored.")] = None,
    ...
    @validate_call
    def currency_id_delete_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Internal identifier.")],
        prefer: Annotated[Optional[StrictStr], Field(description="The server behavior requested by the client. Use 'respond-async' to execute the request asynchronously. If the request is executed asynchronously, 'Preference-applied: respond-async' is returned in the response.")] = None,
        x_net_suite_idempotency_key: Annotated[Optional[StrictStr], Field(description="A user-defined unique idempotency key that is applied to every asynchronous requests to ensure that the request is executed only once. Only one request can be executed with every unique idempotency key. Use UUID in string format as defined by RFC 4122. If the request is executed synchronously, this value is ignored.")] = None,
    ...
    def _currency_id_delete_serialize(
        self,
        id,
        prefer,
        x_net_suite_idempotency_key,
    ...
    def currency_id_get(
        ...
        _param = self._currency_id_get_serialize(
            id=id,
            prefer=prefer,
            x_net_suite_idempotency_key=x_net_suite_idempotency_key,
    ...
    @validate_call
    def currency_id_get_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Internal identifier.")],
        prefer: Annotated[Optional[StrictStr], Field(description="The server behavior requested by the client. Use 'respond-async' to execute the request asynchronously. If the request is executed asynchronously, 'Preference-applied: respond-async' is returned in the response.")] = None,
        x_net_suite_idempotency_key: Annotated[Optional[StrictStr], Field(description="A user-defined unique idempotency key that is applied to every asynchronous requests to ensure that the request is executed only once. Only one request can be executed with every unique idempotency key. Use UUID in string format as defined by RFC 4122. If the request is executed synchronously, this value is ignored.")] = None,
    ...
    @validate_call
    def currency_id_get_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Internal identifier.")],
        prefer: Annotated[Optional[StrictStr], Field(description="The server behavior requested by the client. Use 'respond-async' to execute the request asynchronously. If the request is executed asynchronously, 'Preference-applied: respond-async' is returned in the response.")] = None,
        x_net_suite_idempotency_key: Annotated[Optional[StrictStr], Field(description="A user-defined unique idempotency key that is applied to every asynchronous requests to ensure that the request is executed only once. Only one request can be executed with every unique idempotency key. Use UUID in string format as defined by RFC 4122. If the request is executed synchronously, this value is ignored.")] = None,
    ...
    def _currency_id_get_serialize(
        self,
        id,
        prefer,
        x_net_suite_idempotency_key,
    ...
    @validate_call
    def currency_id_patch(
        self,
        id: Annotated[StrictInt, Field(description="Internal identifier.")],
        currency: Annotated[Currency, Field(description="Request body.")],
        prefer: Annotated[Optional[StrictStr], Field(description="The server behavior requested by the client. Use 'respond-async' to execute the request asynchronously. If the request is executed asynchronously, 'Preference-applied: respond-async' is returned in the response.")] = None,
        x_net_suite_idempotency_key: Annotated[Optional[StrictStr], Field(description="A user-defined unique idempotency key that is applied to every asynchronous requests to ensure that the request is executed only once. Only one request can be executed with every unique idempotency key. Use UUID in string format as defined by RFC 4122. If the request is executed synchronously, this value is ignored.")] = None,
        ...
        :param id: Internal identifier. (required)
        :type id: int
        :param currency: Request body. (required)
        ...
        _param = self._currency_id_patch_serialize(
            id=id,
            currency=currency,
            prefer=prefer,
            x_net_suite_idempotency_key=x_net_suite_idempotency_key,
    ...
    @validate_call
    def currency_id_patch_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Internal identifier.")],
        currency: Annotated[Currency, Field(description="Request body.")],
        prefer: Annotated[Optional[StrictStr], Field(description="The server behavior requested by the client. Use 'respond-async' to execute the request asynchronously. If the request is executed asynchronously, 'Preference-applied: respond-async' is returned in the response.")] = None,
    ...
    @validate_call
    def currency_id_patch_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Internal identifier.")],
        currency: Annotated[Currency, Field(description="Request body.")],
        prefer: Annotated[Optional[StrictStr], Field(description="The server behavior requested by the client. Use 'respond-async' to execute the request asynchronously. If the request is executed asynchronously, 'Preference-applied: respond-async' is returned in the response.")] = None,
    ...
    def _currency_id_patch_serialize(
        self,
        id,
        currency,
        prefer,
    ...
    def currency_id_put(
        ...
        _param = self._currency_id_put_serialize(
            id=id,
            currency=currency,
            prefer=prefer,
            x_net_suite_idempotency_key=x_net_suite_idempotency_key,
    ...
    @validate_call
    def currency_id_put_with_http_info(
        self,
        id: Annotated[str, Field(strict=True, description="External identifier.")],
        currency: Annotated[Currency, Field(description="Request body.")],
        prefer: Annotated[Optional[StrictStr], Field(description="The server behavior requested by the client. Use 'respond-async' to execute the request asynchronously. If the request is executed asynchronously, 'Preference-applied: respond-async' is returned in the response.")] = None,
    ...
    @validate_call
    def currency_id_put_without_preload_content(
        self,
        id: Annotated[str, Field(strict=True, description="External identifier.")],
        currency: Annotated[Currency, Field(description="Request body.")],
        prefer: Annotated[Optional[StrictStr], Field(description="The server behavior requested by the client. Use 'respond-async' to execute the request asynchronously. If the request is executed asynchronously, 'Preference-applied: respond-async' is returned in the response.")] = None,
    ...
    def _currency_id_put_serialize(
        self,
        id,
        currency,
        prefer,
