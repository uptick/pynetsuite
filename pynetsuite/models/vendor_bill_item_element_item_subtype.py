...
class VendorBillItemElementItemSubtype(BaseModel):
    """
    ...
    def id_validate_enum(cls, value):
        ...
        if value not in set(['Sale', 'Purchase', 'Resale']):
            raise ValueError("must be one of enum values ('Sale', 'Purchase', 'Resale')")
        return value
