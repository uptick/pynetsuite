...
class TaxType(BaseModel):
    ...
    TaxType
    """ # noqa: E501
    country: Optional[TaxTypeCountry] = None
    custom_form: Optional[TaxTypeCustomForm] = Field(default=None, alias="customForm")
    name: Optional[StrictStr] = Field(default=None, description="Enter a name for this record.")
    ...
    __properties: ClassVar[List[str]] = ["country", "customForm", "name", "externalId", "description", "id", "refName", "links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "country": TaxTypeCountry.from_dict(obj["country"]) if obj.get("country") is not None else None,
            "customForm": TaxTypeCustomForm.from_dict(obj["customForm"]) if obj.get("customForm") is not None else None,
            "name": obj.get("name"),
