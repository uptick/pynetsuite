...
class VendorBillItemInventoryDetailInventoryAssignmentElement(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["links", "packCarton", "quantity", "expirationDate", "inventoryDetail", "receiptInventoryNumber", "internalId", "quantityAvailable", "pickCarton", "refName", "toInventoryStatus", "toBinNumber", "issueInventoryNumber", "inventoryStatus", "binNumber"]
