...
class CurrencyCollection(BaseModel):
    """
    CurrencyCollection
    """ # noqa: E501
    total_results: Optional[StrictInt] = Field(default=None, alias="totalResults")
    items: Optional[List[Currency]] = Field(default=None, description="An array field that represents a collection of elements, for example, sublist lines, multiselect items, or search results.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [Currency.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
