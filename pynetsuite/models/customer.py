...
class Customer(BaseModel):
    ...
    receivables_account: Optional[NsResource] = Field(default=None, alias="receivablesAccount")
    ...
    dr_account: Optional[NsResource] = Field(default=None, alias="drAccount")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "receivablesAccount": NsResource.from_dict(obj["receivablesAccount"]) if obj.get("receivablesAccount") is not None else None,
            ...
            "drAccount": NsResource.from_dict(obj["drAccount"]) if obj.get("drAccount") is not None else None,
