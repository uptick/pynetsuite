...
class AccountGeneralRate(BaseModel):
    """
    AccountGeneralRate
    """ # noqa: E501
    ...
    def id_validate_enum(cls, value):
        ...
        if value not in set(['AVERAGE', 'HISTORICAL', 'CURRENT']):
            raise ValueError("must be one of enum values ('AVERAGE', 'HISTORICAL', 'CURRENT')")
        return value
