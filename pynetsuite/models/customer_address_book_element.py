...
class CustomerAddressBookElement(BaseModel):
    """
    ...
    is_residential: Optional[StrictBool] = Field(default=None, alias="isResidential")
    ...
    address_book_address: Optional[CustomerAddressBookAddressBookAddress] = Field(default=None, alias="addressBookAddress")
    __properties: ClassVar[List[str]] = ["links", "internalId", "defaultBilling", "lastModifiedDate", "addressBookAddress_text", "defaultShipping", "isResidential", "label", "id", "addressId", "refName", "addressBookAddress"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isResidential": obj.get("isResidential"),
            "label": obj.get("label"),
            "id": obj.get("id"),
            "addressId": obj.get("addressId"),
            "refName": obj.get("refName"),
            "addressBookAddress": CustomerAddressBookAddressBookAddress.from_dict(obj["addressBookAddress"]) if obj.get("addressBookAddress") is not None else None
        })
        return _obj
