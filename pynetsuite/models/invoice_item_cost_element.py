...
class InvoiceItemCostElement(BaseModel):
    """
    ...
    item_cost_count: Optional[StrictStr] = Field(default=None, alias="itemCostCount")
    ...
    unit_disp: Optional[StrictStr] = Field(default=None, alias="unitDisp")
    ...
    billed_date: Optional[date] = Field(default=None, alias="billedDate")
    ...
    inventory_detail: Optional[InvoiceItemCostInventoryDetail] = Field(default=None, alias="inventoryDetail")
    ...
    __properties: ClassVar[List[str]] = ["links", "custcol_prj_order_line", "rateSchedule", "memo", "custcol_nxc_end_check", "custcol_vl_item_display_name", "custcol_msl_sitemgtcost", "custcol_5892_eutriangulation", "options", "custcol_4601_witaxbaseamount", "custcol_vl_description_print", "custcol_nx_time_start", "custcol_bb1_margin", "custcol_country_of_origin_name", "custcol_4601_witaxbamt_exp", "custcolcostcentre", "custcol_zc_3wm_matching_id", "custcol_vl_unique_asset_code", "custcol_nx_time_end", "custcol_4601_witaxamount", "custcol_msl_materialcost", "custcol_cs_estimate_quote_ref", "custcol_nx_time_billed", "custcol_vl_linked_transaction_line", "custcol_adjustment_field", "custcol_country_of_origin_code", "custcol_re_work_re_order_check", "custcol_day_rate", "custcol_counterparty_vat", "custcol_4601_witaxline", "custcol_other_rate", "custcol_bb1_temp_itemdisplay", "custcol_reference", "url", "custcol_zc_item_type", "custcol_msl_prelicost", "custcol_quote_reference", "itemCostCount", "custcol_nx_idempotency_key", "custcol_bb1_fp_calculation_completed", "custcol_nx_time_costed", "custcol_4601_witaxrate", "custcol_cs_estimate_add_notes", "custcol_internal_notes", "custcol_statistical_value", "custcol3", "custcol4", "custcol_4601_witaxamt_exp", "unit", "unitDisp", "custcol_ff_sc_po_line", "custcol_ph4014_src_tranintid", "custcol_description_location", "custcol_mark_as_optional", "custcol_4601_witaxrate_exp", "custcol_msl_labourcost", "line", "billedDate", "custcol_statistical_value_base_curr", "custcol_nx_foreignamount", "custcol_nx_time_cost", "amount", "cost", "apply", "custcol_zc_vendor_txn_idx", "custcol_zc_3wm_matching_summary", "custcol_4601_witaxapplies", "custcol_nxc_end_time", "custcol_nxc_start_time", "custcol_ff_sc_matching_status_inline", "custcol_bb1_ventro_fp_orig_rate", "custcol_bb1_targetmarginline", "custcol_nxc_start_check", "custcol_4601_witaxline_exp", "refName", "custcol_sales_consultant_line", "doc", "custcol_nx_projecttask", "custcol_emirate", "custcolrequestorline", "custcol_nx_consumable", "custcol_ff_sc_ammr_rule_applied", "custcol_subcontractor", "custcol_vl_tax_code_print", "custcol_ph4014_src_custid", "custcol_nx_asset", "custcol_ff_sc_vatex_reason", "custcol_4601_witaxcode_exp", "custcol_nxc_case", "department", "custcol_ff_sc_matching_status", "cseg_paactivitycode", "custcol_statistical_procedure_sale", "custcol_bb1_labour_type", "custcol_nondeductible_account", "custcol_nx_case", "inventoryDetail", "custcol_nature_of_transaction_codes", "custcol_bb1_suiteprojects_project_lin", "custcol_ph4014_src_empid", "custcol_ph4014_src_vendorid", "custcol_vl_linked_transaction", "cseg_accreditations", "custcol_4601_itemdefaultwitaxcode", "custcol_ff_sc_po_id", "custcolprojectframeworkprovider", "custcolpmschedulerline", "custcol_4601_witaxcode", "custcol_statistical_procedure_purc", "custcol_pocase", "custcolprojectqsline", "custcol_ph4014_src_jrnltrantypeid", "custcol_adjustment_tax_code", "custcol_expense_code_of_supply", "custcol_nx_task", "item", "location", "custcol_bb1_vehicle_expense", "class"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if item_cost_count (nullable) is None
        # and model_fields_set contains the field
        if self.item_cost_count is None and "item_cost_count" in self.model_fields_set:
            _dict['itemCostCount'] = None
        ...
        # set to None if unit_disp (nullable) is None
        # and model_fields_set contains the field
        if self.unit_disp is None and "unit_disp" in self.model_fields_set:
            _dict['unitDisp'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "itemCostCount": obj.get("itemCostCount"),
            ...
            "inventoryDetail": InvoiceItemCostInventoryDetail.from_dict(obj["inventoryDetail"]) if obj.get("inventoryDetail") is not None else None,
