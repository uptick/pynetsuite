...
class CustomerCurrencyListElement(BaseModel):
    ...
    symbol_placement: Optional[CustomerCurrencyListElementSymbolPlacement] = Field(default=None, alias="symbolPlacement")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "symbolPlacement": CustomerCurrencyListElementSymbolPlacement.from_dict(obj["symbolPlacement"]) if obj.get("symbolPlacement") is not None else None,
