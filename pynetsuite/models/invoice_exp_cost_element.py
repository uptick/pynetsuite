...
class InvoiceExpCostElement(BaseModel):
    """
    ...
    employee: Optional[NsResource] = None
    ...
    __properties: ClassVar[List[str]] = ["links", "custcol_prj_order_line", "memo", "custcol_nxc_end_check", "custcol_vl_item_display_name", "custcol_msl_sitemgtcost", "custcol_5892_eutriangulation", "custcol_4601_witaxbaseamount", "custcol_vl_description_print", "custcol_nx_time_start", "custcol_bb1_margin", "custcol_country_of_origin_name", "custcol_4601_witaxbamt_exp", "custcolcostcentre", "custcol_zc_3wm_matching_id", "custcol_vl_unique_asset_code", "custcol_nx_time_end", "custcol_4601_witaxamount", "custcol_msl_materialcost", "custcol_cs_estimate_quote_ref", "custcol_nx_time_billed", "custcol_vl_linked_transaction_line", "custcol_adjustment_field", "custcol_country_of_origin_code", "custcol_re_work_re_order_check", "custcol_day_rate", "custcol_counterparty_vat", "custcol_4601_witaxline", "custcol_other_rate", "custcol_bb1_temp_itemdisplay", "custcol_reference", "url", "custcol_zc_item_type", "custcol_msl_prelicost", "originalAmount", "custcol_quote_reference", "custcol_nx_idempotency_key", "custcol_bb1_fp_calculation_completed", "custcol_nx_time_costed", "custcol_4601_witaxrate", "custcol_cs_estimate_add_notes", "custcol_internal_notes", "custcol_statistical_value", "custcol3", "custcol4", "custcol_4601_witaxamt_exp", "custcol_ff_sc_po_line", "custcol_ph4014_src_tranintid", "custcol_description_location", "custcol_mark_as_optional", "custcol_4601_witaxrate_exp", "custcol_msl_labourcost", "line", "billedDate", "custcol_statistical_value_base_curr", "custcol_nx_foreignamount", "custcol_nx_time_cost", "amount", "apply", "custcol_zc_vendor_txn_idx", "custcol_zc_3wm_matching_summary", "custcol_4601_witaxapplies", "custcol_nxc_end_time", "custcol_nxc_start_time", "custcol_ff_sc_matching_status_inline", "custcol_bb1_ventro_fp_orig_rate", "custcol_bb1_targetmarginline", "custcol_nxc_start_check", "custcol_4601_witaxline_exp", "refName", "custcol_adjustment_tax_code", "custcol_ff_sc_matching_status", "category", "custcol_ph4014_src_empid", "custcolpmschedulerline", "custcol_4601_itemdefaultwitaxcode", "cseg_accreditations", "class", "custcol_expense_code_of_supply", "custcol_vl_tax_code_print", "custcol_statistical_procedure_purc", "custcol_ff_sc_po_id", "custcol_nx_case", "employee", "custcolprojectframeworkprovider", "custcol_vl_linked_transaction", "cseg_paactivitycode", "custcol_ph4014_src_custid", "custcol_nx_asset", "custcol_nxc_case", "custcol_statistical_procedure_sale", "custcol_ff_sc_vatex_reason", "custcol_subcontractor", "custcol_nondeductible_account", "custcol_bb1_labour_type", "custcol_nx_projecttask", "custcol_ff_sc_ammr_rule_applied", "custcol_sales_consultant_line", "department", "custcol_4601_witaxcode_exp", "custcol_pocase", "custcolrequestorline", "custcol_nx_consumable", "custcol_ph4014_src_jrnltrantypeid", "location", "custcol_ph4014_src_vendorid", "custcolprojectqsline", "doc", "custcol_bb1_suiteprojects_project_lin", "custcol_bb1_vehicle_expense", "custcol_emirate", "custcol_nature_of_transaction_codes", "custcol_nx_task", "custcol_4601_witaxcode"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if original_amount (nullable) is None
        # and model_fields_set contains the field
        if self.original_amount is None and "original_amount" in self.model_fields_set:
            _dict['originalAmount'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "employee": NsResource.from_dict(obj["employee"]) if obj.get("employee") is not None else None,
