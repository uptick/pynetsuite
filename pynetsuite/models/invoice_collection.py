...
class InvoiceCollection(BaseModel):
    ...
    items: Optional[List[Invoice]] = Field(default=None, description="An array field that represents a collection of elements, for example, sublist lines, multiselect items, or search results.")
