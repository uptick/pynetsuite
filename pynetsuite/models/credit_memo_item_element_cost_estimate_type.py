...
class CreditMemoItemElementCostEstimateType(BaseModel):
    """
    ...
    def id_validate_enum(cls, value):
        ...
        if value not in set(['PREFVENDORRATE', 'AVGCOST', 'PURCHORDERRATE', 'LASTPURCHPRICE', 'MEMBERDEFINED', 'CUSTOM', 'ITEMDEFINED', 'PURCHPRICE']):
            raise ValueError("must be one of enum values ('PREFVENDORRATE', 'AVGCOST', 'PURCHORDERRATE', 'LASTPURCHPRICE', 'MEMBERDEFINED', 'CUSTOM', 'ITEMDEFINED', 'PURCHPRICE')")
        return value
