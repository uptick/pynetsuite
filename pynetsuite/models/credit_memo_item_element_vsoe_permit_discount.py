...
class CreditMemoItemElementVsoePermitDiscount(BaseModel):
    """
    ...
    def id_validate_enum(cls, value):
        ...
        if value not in set(['IFDELIVERED', 'NEVER']):
            raise ValueError("must be one of enum values ('IFDELIVERED', 'NEVER')")
        return value
