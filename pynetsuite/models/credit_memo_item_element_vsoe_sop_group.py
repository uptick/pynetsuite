...
class CreditMemoItemElementVsoeSOPGroup(BaseModel):
    """
    ...
    def id_validate_enum(cls, value):
        ...
        if value not in set(['EXCLUDE', 'NORMAL', 'SOFTWARE']):
            raise ValueError("must be one of enum values ('EXCLUDE', 'NORMAL', 'SOFTWARE')")
        return value
