...
class Vendor(BaseModel):
    ...
    default_vendor_payment_account: Optional[Account] = Field(default=None, alias="defaultVendorPaymentAccount")
    ...
    payables_account: Optional[Account] = Field(default=None, alias="payablesAccount")
    ...
    expense_account: Optional[Account] = Field(default=None, alias="expenseAccount")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "defaultVendorPaymentAccount": Account.from_dict(obj["defaultVendorPaymentAccount"]) if obj.get("defaultVendorPaymentAccount") is not None else None,
            ...
            "payablesAccount": Account.from_dict(obj["payablesAccount"]) if obj.get("payablesAccount") is not None else None,
            ...
            "expenseAccount": Account.from_dict(obj["expenseAccount"]) if obj.get("expenseAccount") is not None else None,
            ...
            "custentity_eff_nsp2p_defaultitem": InvoiceItemCostElementItem.from_dict(obj["custentity_eff_nsp2p_defaultitem"]) if obj.get("custentity_eff_nsp2p_defaultitem") is not None else None,
