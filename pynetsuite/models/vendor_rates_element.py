...
class VendorRatesElement(BaseModel):
    ...
    entity_currency: Optional[NsResource] = Field(default=None, alias="entityCurrency")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entityCurrency": NsResource.from_dict(obj["entityCurrency"]) if obj.get("entityCurrency") is not None else None
        })
        return _obj
