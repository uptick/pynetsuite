...
class VendorBillCustomForm(BaseModel):
    """
    ...
    def id_validate_enum(cls, value):
        ...
        if value not in set(['100', '134', '157', '129', '50', '183', '184']):
            raise ValueError("must be one of enum values ('100', '134', '157', '129', '50', '183', '184')")
        return value
