...
class InvoiceItemCostInventoryDetailInventoryAssignmentElement(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["links", "packCarton", "quantity", "expirationDate", "inventoryDetail", "receiptInventoryNumber", "internalId", "quantityAvailable", "pickCarton", "refName", "inventoryStatus", "toInventoryStatus", "binNumber", "toBinNumber", "issueInventoryNumber"]
