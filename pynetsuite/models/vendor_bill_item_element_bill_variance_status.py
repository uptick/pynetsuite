...
class VendorBillItemElementBillVarianceStatus(BaseModel):
    """
    ...
    def id_validate_enum(cls, value):
        ...
        if value not in set(['NOVARIANCES', 'JOURNALNOTPOSTED', 'JOURNALPOSTED']):
            raise ValueError("must be one of enum values ('NOVARIANCES', 'JOURNALNOTPOSTED', 'JOURNALPOSTED')")
        return value
