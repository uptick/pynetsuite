...
class VendorBillItemElement(BaseModel):
    """
    ...
    amortiz_start_date: Optional[date] = Field(default=None, alias="amortizStartDate")
    ...
    amortization_residual: Optional[StrictStr] = Field(default=None, alias="amortizationResidual")
    ...
    amortization_end_date: Optional[date] = Field(default=None, alias="amortizationEndDate")
    ...
    amortization_type: Optional[StrictStr] = Field(default=None, alias="amortizationType")
    ...
    is_vsoe_bundle: Optional[StrictStr] = Field(default=None, alias="isVsoeBundle")
    ...
    defer_rev_rec: Optional[StrictBool] = Field(default=None, alias="deferRevRec")
    ...
    is_billable: Optional[StrictBool] = Field(default=None, alias="isBillable")
    ...
    bill_receipts: Optional[NsResourceCollection] = Field(default=None, alias="billReceipts")
    ...
    amortization_sched: Optional[NsResource] = Field(default=None, alias="amortizationSched")
    ...
    inventory_detail: Optional[VendorBillItemInventoryDetail] = Field(default=None, alias="inventoryDetail")
    ...
    catch_up_period: Optional[NsResource] = Field(default=None, alias="catchUpPeriod")
    ...
    customer: Optional[VendorBillItemElementCustomer] = None
    custcol_nondeductible_account: Optional[NsResource] = None
    projecttask: Optional[NsResource] = None
    custcol_statistical_procedure_sale: Optional[NsResource] = None
    custcol_nx_asset: Optional[NsResource] = None
    __properties: ClassVar[List[str]] = ["links", "custcol_prj_order_line", "scheduleType", "amortizStartDate", "rateSchedule", "custcol_vl_item_display_name", "custcol_nxc_end_check", "custcol_msl_sitemgtcost", "custcol_5892_eutriangulation", "options", "custcol_4601_witaxbaseamount", "custcol_vl_description_print", "custcol_nx_time_start", "custcol_bb1_margin", "custcol_country_of_origin_name", "custcol_4601_witaxbamt_exp", "custcolcostcentre", "billVarianceStatus", "custcol_zc_3wm_matching_id", "custcol_vl_unique_asset_code", "custcol_nx_time_end", "custcol_4601_witaxamount", "custcol_msl_materialcost", "custcol_cs_estimate_quote_ref", "custcol_nx_time_billed", "amortizationResidual", "custcol_vl_linked_transaction_line", "custcol_adjustment_field", "custcol_country_of_origin_code", "custcol_re_work_re_order_check", "linked", "custcol_day_rate", "custcol_counterparty_vat", "custcol_4601_witaxline", "custcol_other_rate", "custcol_bb1_temp_itemdisplay", "custcol_reference", "custcol_zc_item_type", "custcol_msl_prelicost", "custcol_quote_reference", "amortizationEndDate", "custcol_nx_idempotency_key", "custcol_bb1_fp_calculation_completed", "custcol_nx_time_costed", "custcol_4601_witaxrate", "custcol_cs_estimate_add_notes", "custcol_internal_notes", "custcol_statistical_value", "custcol3", "custcol4", "oqpBucket", "itemSubtype", "amortizationType", "custcol_4601_witaxamt_exp", "custcol_ff_sc_po_line", "custcol_ph4014_src_tranintid", "isVsoeBundle", "custcol_description_location", "custcol_mark_as_optional", "matrixType", "custcol_4601_witaxrate_exp", "vendorName", "deferRevRec", "custcol_msl_labourcost", "isOpen", "line", "description", "isClosed", "units", "custcol_statistical_value_base_curr", "custcol_nx_foreignamount", "rate", "marginal", "custcol_nx_time_cost", "printItems", "isBillable", "amount", "quantity", "initOqpBucket", "custcol_zc_vendor_txn_idx", "custcol_zc_3wm_matching_summary", "custcol_nxc_end_time", "custcol_4601_witaxapplies", "orderLine", "custcol_nxc_start_time", "itemType", "custcol_ff_sc_matching_status_inline", "custcol_bb1_ventro_fp_orig_rate", "custcol_bb1_targetmarginline", "custcol_nxc_start_check", "custcol_4601_witaxline_exp", "refName", "custcol_bb1_labour_type", "custcolrequestorline", "custcol_pocase", "custcol_sales_consultant_line", "custcol_ph4014_src_custid", "custcol_4601_witaxcode_exp", "department", "custcol_nx_projecttask", "custcol_ff_sc_ammr_rule_applied", "custcol_subcontractor", "billReceipts", "custcol_nx_task", "custcolprojectqsline", "custcol_nx_consumable", "custcol_4601_witaxcode", "location", "custcol_ph4014_src_jrnltrantypeid", "custcol_bb1_suiteprojects_project_lin", "custcol_ff_sc_po_id", "custcol_nature_of_transaction_codes", "amortizationSched", "class", "custcol_emirate", "item", "custcol_bb1_vehicle_expense", "inventoryDetail", "cseg_accreditations", "custcol_adjustment_tax_code", "custcol_expense_code_of_supply", "custcolpmschedulerline", "custcol_4601_itemdefaultwitaxcode", "custcol_ff_sc_matching_status", "custcol_nx_case", "custcol_statistical_procedure_purc", "custcolprojectframeworkprovider", "custcol_vl_tax_code_print", "custcol_ph4014_src_empid", "subsidiary", "custcol_ph4014_src_vendorid", "orderDoc", "catchUpPeriod", "custcol_vl_linked_transaction", "cseg_paactivitycode", "custcol_nxc_case", "custcol_ff_sc_vatex_reason", "customer", "custcol_nondeductible_account", "projecttask", "custcol_statistical_procedure_sale", "custcol_nx_asset"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VendorBillItemElement from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of bill_receipts
        if self.bill_receipts:
            _dict['billReceipts'] = self.bill_receipts.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of amortization_sched
        if self.amortization_sched:
            _dict['amortizationSched'] = self.amortization_sched.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of catch_up_period
        if self.catch_up_period:
            _dict['catchUpPeriod'] = self.catch_up_period.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of projecttask
        if self.projecttask:
            _dict['projecttask'] = self.projecttask.to_dict()
        ...
        # set to None if amortiz_start_date (nullable) is None
        # and model_fields_set contains the field
        if self.amortiz_start_date is None and "amortiz_start_date" in self.model_fields_set:
            _dict['amortizStartDate'] = None
        ...
        # set to None if amortization_residual (nullable) is None
        # and model_fields_set contains the field
        if self.amortization_residual is None and "amortization_residual" in self.model_fields_set:
            _dict['amortizationResidual'] = None
        ...
        # set to None if amortization_end_date (nullable) is None
        # and model_fields_set contains the field
        if self.amortization_end_date is None and "amortization_end_date" in self.model_fields_set:
            _dict['amortizationEndDate'] = None
        ...
        # set to None if amortization_type (nullable) is None
        # and model_fields_set contains the field
        if self.amortization_type is None and "amortization_type" in self.model_fields_set:
            _dict['amortizationType'] = None
        ...
        # set to None if is_vsoe_bundle (nullable) is None
        # and model_fields_set contains the field
        if self.is_vsoe_bundle is None and "is_vsoe_bundle" in self.model_fields_set:
            _dict['isVsoeBundle'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VendorBillItemElement from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "amortizStartDate": obj.get("amortizStartDate"),
            ...
            "amortizationResidual": obj.get("amortizationResidual"),
            ...
            "amortizationEndDate": obj.get("amortizationEndDate"),
            ...
            "isVsoeBundle": obj.get("isVsoeBundle"),
            ...
            "deferRevRec": obj.get("deferRevRec"),
            ...
            "billReceipts": NsResourceCollection.from_dict(obj["billReceipts"]) if obj.get("billReceipts") is not None else None,
            ...
            "amortizationSched": NsResource.from_dict(obj["amortizationSched"]) if obj.get("amortizationSched") is not None else None,
            ...
            "inventoryDetail": VendorBillItemInventoryDetail.from_dict(obj["inventoryDetail"]) if obj.get("inventoryDetail") is not None else None,
            ...
            "catchUpPeriod": NsResource.from_dict(obj["catchUpPeriod"]) if obj.get("catchUpPeriod") is not None else None,
            ...
            "customer": VendorBillItemElementCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None,
            "custcol_nondeductible_account": NsResource.from_dict(obj["custcol_nondeductible_account"]) if obj.get("custcol_nondeductible_account") is not None else None,
            "projecttask": NsResource.from_dict(obj["projecttask"]) if obj.get("projecttask") is not None else None,
