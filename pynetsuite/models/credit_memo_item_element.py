...
class CreditMemoItemElement(BaseModel):
    """
    ...
    inventory_detail: Optional[CreditMemoItemInventoryDetail] = Field(default=None, alias="inventoryDetail")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inventoryDetail": CreditMemoItemInventoryDetail.from_dict(obj["inventoryDetail"]) if obj.get("inventoryDetail") is not None else None,
