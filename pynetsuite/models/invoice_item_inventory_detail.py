...
class InvoiceItemInventoryDetail(BaseModel):
    """
    ...
    inventory_assignment: Optional[InvoiceItemInventoryDetailInventoryAssignmentCollection] = Field(default=None, alias="inventoryAssignment")
    to_location: Optional[NsResource] = Field(default=None, alias="toLocation")
    __properties: ClassVar[List[str]] = ["itemDescription", "unit", "quantity", "customForm", "externalId", "refName", "links", "location", "item", "inventoryAssignment", "toLocation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inventoryAssignment": InvoiceItemInventoryDetailInventoryAssignmentCollection.from_dict(obj["inventoryAssignment"]) if obj.get("inventoryAssignment") is not None else None,
