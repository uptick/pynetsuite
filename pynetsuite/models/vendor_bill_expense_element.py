...
class VendorBillExpenseElement(BaseModel):
    """
    ...
    order_doc: Optional[StrictStr] = Field(default=None, alias="orderDoc")
    ...
    order_line: Optional[StrictStr] = Field(default=None, alias="orderLine")
    ...
    __properties: ClassVar[List[str]] = ["links", "custcol_prj_order_line", "scheduleType", "amortizStartDate", "memo", "custcol_nxc_end_check", "custcol_vl_item_display_name", "custcol_msl_sitemgtcost", "custcol_5892_eutriangulation", "custcol_4601_witaxbaseamount", "custcol_vl_description_print", "custcol_nx_time_start", "custcol_bb1_margin", "custcol_country_of_origin_name", "custcol_4601_witaxbamt_exp", "custcolcostcentre", "custcol_zc_3wm_matching_id", "custcol_vl_unique_asset_code", "custcol_nx_time_end", "custcol_4601_witaxamount", "custcol_msl_materialcost", "custcol_cs_estimate_quote_ref", "custcol_nx_time_billed", "amortizationResidual", "custcol_vl_linked_transaction_line", "custcol_adjustment_field", "custcol_country_of_origin_code", "custcol_re_work_re_order_check", "custcol_day_rate", "custcol_counterparty_vat", "custcol_4601_witaxline", "custcol_other_rate", "custcol_bb1_temp_itemdisplay", "custcol_reference", "custcol_zc_item_type", "custcol_msl_prelicost", "custcol_quote_reference", "amortizationEndDate", "custcol_nx_idempotency_key", "custcol_bb1_fp_calculation_completed", "custcol_nx_time_costed", "custcol_4601_witaxrate", "custcol_cs_estimate_add_notes", "custcol_internal_notes", "custcol_statistical_value", "custcol3", "custcol4", "amortizationType", "custcol_4601_witaxamt_exp", "custcol_ff_sc_po_line", "custcol_ph4014_src_tranintid", "custcol_description_location", "custcol_mark_as_optional", "orderDoc", "custcol_4601_witaxrate_exp", "custcol_msl_labourcost", "line", "custcol_statistical_value_base_curr", "custcol_nx_foreignamount", "custcol_nx_time_cost", "amount", "isBillable", "custcol_zc_vendor_txn_idx", "custcol_zc_3wm_matching_summary", "custcol_4601_witaxapplies", "custcol_nxc_end_time", "orderLine", "custcol_nxc_start_time", "custcol_ff_sc_matching_status_inline", "custcol_bb1_ventro_fp_orig_rate", "custcol_bb1_targetmarginline", "custcol_nxc_start_check", "custcol_4601_witaxline_exp", "refName", "custcol_nondeductible_account", "custcol_nx_projecttask", "custcolrequestorline", "custcol_statistical_procedure_sale", "custcol_bb1_labour_type", "custcol_sales_consultant_line", "custcol_ff_sc_ammr_rule_applied", "custcol_emirate", "custcol_subcontractor", "custcol_nx_consumable", "custcol_ph4014_src_custid", "custcol_4601_witaxcode", "custcol_vl_tax_code_print", "custcol_nx_task", "custcolprojectframeworkprovider", "class", "location", "custcol_pocase", "custcolpmschedulerline", "custcol_bb1_vehicle_expense", "custcol_statistical_procedure_purc", "custcol_ff_sc_po_id", "custcol_ph4014_src_jrnltrantypeid", "custcol_expense_code_of_supply", "custcolprojectqsline", "projecttask", "custcol_nx_case", "custcol_nature_of_transaction_codes", "custcol_adjustment_tax_code", "custcol_vl_linked_transaction", "custcol_ph4014_src_empid", "custcol_ph4014_src_vendorid", "custcol_bb1_suiteprojects_project_lin", "amortizationSched", "cseg_accreditations", "custcol_4601_itemdefaultwitaxcode", "custcol_nxc_case", "custcol_nx_asset", "custcol_ff_sc_vatex_reason", "department", "custcol_4601_witaxcode_exp", "custcol_ff_sc_matching_status", "account", "category", "customer", "cseg_paactivitycode"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if order_doc (nullable) is None
        # and model_fields_set contains the field
        if self.order_doc is None and "order_doc" in self.model_fields_set:
            _dict['orderDoc'] = None
