...
class NsResourceCollection(BaseModel):
    """
    ...
    items: Optional[List[NsResource]] = None
    count: Optional[StrictInt] = None
    has_more: Optional[StrictBool] = Field(default=None, alias="hasMore")
    offset: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["links", "totalResults", "items", "count", "hasMore", "offset"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [NsResource.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "count": obj.get("count"),
