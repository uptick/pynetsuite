...
class CreditMemoWhichChargesToAdd(BaseModel):
    """
    ...
    def id_validate_enum(cls, value):
        ...
        if value not in set(['', 'ALL', 'TRANSACTION_DATE', 'AS_OF_DATE']):
            raise ValueError("must be one of enum values ('', 'ALL', 'TRANSACTION_DATE', 'AS_OF_DATE')")
        return value
