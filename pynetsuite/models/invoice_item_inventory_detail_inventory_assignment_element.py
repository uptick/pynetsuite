...
class InvoiceItemInventoryDetailInventoryAssignmentElement(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["links", "packCarton", "quantity", "expirationDate", "inventoryDetail", "receiptInventoryNumber", "internalId", "quantityAvailable", "pickCarton", "refName", "inventoryStatus", "toInventoryStatus", "issueInventoryNumber", "toBinNumber", "binNumber"]
