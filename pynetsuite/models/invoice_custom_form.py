...
class InvoiceCustomForm(BaseModel):
    """
    InvoiceCustomForm
    """ # noqa: E501
    ...
    def id_validate_enum(cls, value):
        ...
        if value not in set(['177', '113', '139', '190', '160', '171', '152']):
            raise ValueError("must be one of enum values ('177', '113', '139', '190', '160', '171', '152')")
        return value
