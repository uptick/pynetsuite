...
class AccountLocalizationsCollection(BaseModel):
    """
    ...
    items: Optional[List[AccountLocalizationsElement]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [AccountLocalizationsElement.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
