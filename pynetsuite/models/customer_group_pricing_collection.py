...
class CustomerGroupPricingCollection(BaseModel):
    """
    ...
    items: Optional[List[CustomerGroupPricingElement]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [CustomerGroupPricingElement.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
